...
os.makedirs(os.path.join(BASE_DIR, 'infrastructure'), exist_ok=True)
os.makedirs(os.path.join(BASE_DIR, 'application'), exist_ok=True)
...
open(os.path.join(BASE_DIR, 'domain', '__init__.py'), 'w').close()
open(os.path.join(BASE_DIR, 'infrastructure', '__init__.py'), 'w').close()
open(os.path.join(BASE_DIR, 'application', '__init__.py'), 'w').close()
open(os.path.join(BASE_DIR, 'interfaces', '__init__.py'), 'w').close()
open(os.path.join(BASE_DIR, 'api', '__init__.py'), 'w').close()

val_obj_content = textwrap.dedent("""\
\"\"\"
...
class GiftCartStatus(str, Enum):
    ...
    ABANDONED = "ABANDONED"
""")
with open(os.path.join(BASE_DIR, 'domain', 'value_objects.py'), 'w') as f: f.write(val_obj_content)

state_machine_content = textwrap.dedent("""\
\"\"\"
...
""")
with open(os.path.join(BASE_DIR, 'domain', 'state_machine.py'), 'w') as f: f.write(state_machine_content)
...
""")
with open(os.path.join(BASE_DIR, 'infrastructure', 'models.py'), 'w') as f: f.write(models_content)
